            ...
            <div className="panel-pane pane-texto">
              <div className="pane-content">
                <p style={{ textAlign: "center" }}>
                  Ponete al dia con lo que pasa en nuestra Municipalidad
                </p>
              </div>
            </div>
            <div className="panel-separator"></div>
              ...
              <div className="pane-content">
                <div className="row panels-row m-t-2 ">
                  <div className="col-xs-12 col-sm-6 col-md-4">
                    <a
                      href="/tema/documentacion"
                      className="panel panel-default"
                    >
                      <img
                        src="/images/palacioMuni.jpg"
                        alt=""
                        style={{ width: "100%" }}
                      />
                      <div className="panel-body home-new m-b-1">
                        ...
                        <p>
                          Del DNI a la cédula verde o el Certificado Único de
                          Discapacidad, te explicamos cómo y dónde tramitar los
                          documentos de uso habitual.
                        </p>
                        <div className="icon-arrow-right text-primary">
                          <i className="fa fa-arrow-right"></i>
                          <span className="sr-only">
                            ícono flecha ir al contenido
                          </span>
                        </div>
                      </div>
                    </a>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-4">
                    <a href="/tema/estudiar" className="panel panel-default">
                      ...
                      <div className="panel-body home-new m-b-1">
                        ...
                        <p>
                          Para nivel inicial, primario, secundario o superior;
                          para argentinos o extranjeros, te presentamos los
                          servicios y beneficios que podés gestionar.
                        </p>
                        <div className="icon-arrow-right text-primary">
                          <i className="fa fa-arrow-right"></i>
                          <span className="sr-only">
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-4">
                    <a href="/tema/trabajar" className="panel panel-default">
                      ...
                      <div className="panel-body home-new m-b-1">
                        ...
                        <p>
                          Si estás en relación de dependencia o sos
                          monotributista, si buscás trabajo o querés
                          capacitarte, estos trámites y servicios te pueden ser
                          de utilidad.
                        </p>
                        <div className="icon-arrow-right text-primary">
                          <i className="fa fa-arrow-right"></i>
