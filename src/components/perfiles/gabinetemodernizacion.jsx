const PerfilGabineteModernizacion = () => {
  return (
    <main role="main" className="PerfilIntendente container">
        <div className="PerfilIntendente__contenedor">
            <div className="PerfilIntendente__contenedor-imagen">
                <img src="/images/mariano.jpeg" alt="" className="PerfilIntendente__imagen"/>
                <div className="PerfilIntendente__informacion">
                    <h1 className="PerfilIntendente__nombre">Mariano Rosales</h1>
                    <h2 className="PerfilIntendente__cargo">
                        Secretaria de Gabinete y Modernización
                    </h2>
                    <q>Por una Catamarca mas Tecnologica</q>
                    <br />
...
export default PerfilGabineteModernizacion;
